...
-> The crankshaft is forged from steel billets using hot forging.
-> Metal is plastically deformed under high compressive forces, ensuring directional grain flow along the crank webs and journals.
-> This improves fatigue strength, impact resistance, and durability.
-> Forged crankshafts are compact, dense, and free from internal defects.
...
-> Molten metal (usually cast iron) is poured into a mould shaped like the crankshaft.
-> After solidification, the casting is machined to required dimensions.
-> Casting allows complex shapes but produces random grain structure.
...
-> Operations include turning, milling, drilling, and grinding.
-> Critical surfaces such as main journals and crank pins are ground to high precision.
-> Machining ensures dimensional accuracy, surface finish, and alignment.
...
2. Nitriding
-> Journals and fillets are selectively hardened.
-> Core remains tough while the surface becomes hard.

**Result:** Improved resistance to wear, bending, and cyclic stresses.

**5. CRANKSHAFT DIES AND THEIR ARRANGEMENT:**
-> Forging is carried out using matched dies (upper and lower dies).
-> Dies are designed to gradually form:
1.Crank pins
2.Main journals
3.Webs

-> Proper die arrangement ensures:
1.Uniform metal flow
2.Minimum defects
3.Accurate crank geometry

Die forging improves repeatability and mass production efficiency.
